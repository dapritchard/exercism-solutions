...
(defn learning-list
  ...
  []
  (let [step1 (new-list)
        step2-a (add-language step1 "Clojure")
        step2-b (add-language step2-a "Lisp")
        step3 (remove-language step2-b)
        step4 (add-language step3 "Java")
        step5 (add-language step4 "JavaScript")]
    (count step5)))
